  ...
  try {
    const completion = await groq.chat.completions.create({
      messages: [{ role: 'user', content: message },
                { role: 'system', content: 'Jawaban Anda harus seperti seorang konsultan dan tertata rapi, menggunakan paragraf, dan Anda dapat menggunakan <strong>bold</strong> untuk menekankan bagian penting. 
